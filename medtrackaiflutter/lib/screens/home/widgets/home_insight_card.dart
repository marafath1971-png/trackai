            ...
            children: [
                        ...
                        ClipRRect(
                          ...
                          child: BackdropFilter(
                            ...
                            child: TextButton.icon(
                              ...
                              label: Text('Ask AI', style: TextStyle(color: L.text, fontSize: 11, fontWeight: FontWeight.w800)),
              ...
              if (insights.isEmpty)
                ...
                Stack(
                  ...
                  children: [
                    SizedBox(
                      height: 250, // Increased further to prevent overflow
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Flexible(
                                          child: Text(
                                            step,
                                            style: TextStyle(color: L.text, fontSize: 11, fontWeight: FontWeight.w600),
                                            maxLines: 1,
                                            overflow: TextOverflow.ellipsis,
                                          ),
                                        ),
